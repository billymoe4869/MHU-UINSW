...
import DeleteAnnounBtn from "@/components/admin/button/DeleteAnnounBtn";
import { getAllAnnouncementAdmin } from "@/lib/service/announcement";
import { MdEdit } from "react-icons/md";
import { PiPlusBold } from "react-icons/pi";

export default async function DaftarPengumuman() {
  const Announ = await getAllAnnouncementAdmin();
